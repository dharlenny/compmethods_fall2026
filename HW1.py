...
# dictionary of planets and their gravities if user selects a planet
...
# determines what parser argument is needed if the user selects their own gravity or a planet
if args.planet:
    planet = args.planet
